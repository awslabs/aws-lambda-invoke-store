...
- Added optional boolean argumanet to force the use of InvokeStoreMulti(AsyncLocalStorage). ([PR #34](https://github.com/awslabs/aws-lambda-invoke-store/pull/34))
